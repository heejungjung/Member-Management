...
public class MemberProc { 
	...
	MemberDAOforTestblah dao;
	
	//기본생성자
	public MemberProc() {
		dao = new MemberDAOforTestblah();
	}
	...
	*/
	public void insertMember(){			
		...
		String m_age = reInput(scn);
		System.out.print("▶연락처 : ");
		//String phoneNum = scn.nextLine();		
		String m_phone = reInput(scn);		

		MemberDTO dto = new MemberDTO(m_name, m_age, m_phone);	
	...
	*/
	public void showMemberList(){
		...
		if(list!=null&&list.size()>0){			
			System.out.println("reg.No\t  이름 \t\t나이\t\t연락처");
			System.out.println("============================================");
	...
	*/
	public void searchMember(){
		...
		String name = scn.nextLine();
		MemberDTO dto = dao.getMemberbyname(name);
	...
	public void updateMember(){
		...
		if (dto!=null) {
			...
			if(input.equalsIgnoreCase("y")){
				...
				if((age).trim().equals("")) age=dto.getAge()+"";
				System.out.print("▶수정할 전화번호 : ");
				String phoneNum = scn.nextLine();
				if(phoneNum.trim().equals("")) phoneNum=dto.getPhone();
				
				dto =  new MemberDTO(no,name, age, phoneNum);
